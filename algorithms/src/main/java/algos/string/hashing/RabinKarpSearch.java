...
public class RabinKarpSearch {
    ...
    public int patternSearch(char[] text, char[] pattern){
        ...
        int n = text.length;
        String patternSubstring = new String(pattern).substring(0, m);
        System.out.println("Pattern Substring "+ patternSubstring);

        String textSubstring = new String(text).substring(0, m);
        System.out.println("Text Substring "+ textSubstring);
        long patternHash = createHash(pattern, m - 1);
        System.out.println("Input hash "+patternHash);
        ...
        for (int i = 1; i <= n - m + 1; i++) {
            ...
            if(i < n - m + 1) {
                textSubstring = new String(text).substring(i, i+m);
                System.out.println("Text Substring "+ textSubstring);
    ...
    public static void main(String args[]){
        ...
        System.out.println(rks.patternSearch("ImtiyazBaig".toCharArray(), "Baig".toCharArray()));
